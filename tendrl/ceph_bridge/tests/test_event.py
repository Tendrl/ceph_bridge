import datetime
from tendrl.ceph_bridge.persistence import event
        ...
        assert self.event.render() == [
            {
                'value': None,
                'name': 'fqdn',
                'key': '/clusters/ceph/None/events/None/fqdn',
                'dir': False
            },
            {
                'value': None,
                'name': 'fsid',
                'key': '/clusters/ceph/None/events/None/fsid',
                'dir': False
            },
            {
                'value': None,
                'name': 'uuid',
                'key': '/clusters/ceph/None/events/None/uuid',
                'dir': False
            },
            {
                'value': None,
                'name': 'message',
                'key': '/clusters/ceph/None/events/None/message',
                'dir': False
            },
            {
                'value': None,
                'name': 'service_id',
                'key': '/clusters/ceph/None/events/None/service_id',
                'dir': False
            },
            {
                'value': None,
                'name': 'service_type',
                'key': '/clusters/ceph/None/events/None/service_type',
                'dir': False
            },
            {
                'value': None,
                'name': 'severity',
                'key': '/clusters/ceph/None/events/None/severity',
                'dir': False
            },
            {
                'value': '2008-09-03T00:00:00',
                'name': 'when',
                'key': '/clusters/ceph/None/events/None/when',
                'dir': False
            }]
